...
export const BlurImage = ({
  ...
  const hasBlur = typeof src === "string" && src.length > 0;
  const usesFill = (rest as Partial<ImageProps>).fill === true;
  return (
    <Image
      className={cn(
      ...
      blurDataURL={hasBlur ? (src as string) : undefined}
      sizes={usesFill ? "100vw" : undefined}
